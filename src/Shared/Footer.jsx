  ...
  return (
    <div>
      <footer className="footer footer-center bg-gray-900 text-white  rounded p-10">
        ...
        <aside>
          <p>
          Copyrights © 2020.All rights reserved.Design With Love By <span className="bg-gradient-to-r to-purple-800  via-slate-400  from-pink-300 bg-clip-text tracking-tight text-transparent text-xl">Jannatun Fima</span>
          </p>
        </aside>
      </footer>
    </div>
